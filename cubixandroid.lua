...
-- // INSTANCES: 322 | SCRIPTS: 10 | MODULES: 0 \\ --
...
-- // StarterGui.Cubix.UI.Settings.language \\ --
UI["fb"] = Instance.new("Frame", UI["c9"])
UI["fb"]["BorderSizePixel"] = 0
UI["fb"]["BackgroundColor3"] = Color3.fromRGB(17, 11, 23)
UI["fb"]["Size"] = UDim2.new(0.10465, 0, 0.71434, 0)
UI["fb"]["Position"] = UDim2.new(0.77451, 0, 0.12868, 0)
UI["fb"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["fb"]["Name"] = [[language]]

-- // StarterGui.Cubix.UI.Settings.language.UICorner \\ --
UI["fc"] = Instance.new("UICorner", UI["fb"])


-- // StarterGui.Cubix.UI.Settings.language.Languages \\ --
UI["fd"] = Instance.new("ScrollingFrame", UI["fb"])
UI["fd"]["Active"] = true
UI["fd"]["BorderSizePixel"] = 0
UI["fd"]["CanvasSize"] = UDim2.new(0, 0, 17, 0)
UI["fd"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["fd"]["Name"] = [[Languages]]
UI["fd"]["Size"] = UDim2.new(0.988, 0, 1, 0)
UI["fd"]["ScrollBarImageColor3"] = Color3.fromRGB(0, 0, 0)
UI["fd"]["Position"] = UDim2.new(0, 0, -0, 0)
UI["fd"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["fd"]["BackgroundTransparency"] = 1

-- // StarterGui.Cubix.UI.Settings.language.Languages.ButtonClone \\ --
UI["fe"] = Instance.new("Folder", UI["fd"])
UI["fe"]["Name"] = [[ButtonClone]]

-- // StarterGui.Cubix.UI.Settings.language.Languages.ButtonClone.languagebutton \\ --
UI["ff"] = Instance.new("TextButton", UI["fe"])
UI["ff"]["TextWrapped"] = true
UI["ff"]["BorderSizePixel"] = 0
UI["ff"]["TextSize"] = 25
UI["ff"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["ff"]["TextScaled"] = true
UI["ff"]["BackgroundColor3"] = Color3.fromRGB(9, 6, 12)
UI["ff"]["FontFace"] = Font.new([[rbxassetid://12187377099]], Enum.FontWeight.Regular, Enum.FontStyle.Normal)
UI["ff"]["Size"] = UDim2.new(0.19299, 0, 0.08423, 0)
UI["ff"]["Name"] = [[languagebutton]]
UI["ff"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["ff"]["Text"] = [[language]]
UI["ff"]["Visible"] = false
UI["ff"]["Position"] = UDim2.new(0.40535, 0, 0.87901, 0)

-- // StarterGui.Cubix.UI.Settings.language.Languages.ButtonClone.languagebutton.UICorner \\ --
UI["100"] = Instance.new("UICorner", UI["ff"])
UI["100"]["CornerRadius"] = UDim.new(0, 5)

-- // StarterGui.Cubix.UI.Settings.language.Languages.ButtonClone.languagebutton.UIStroke \\ --
UI["101"] = Instance.new("UIStroke", UI["ff"])
UI["101"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border
UI["101"]["Color"] = Color3.fromRGB(26, 16, 35)

-- // StarterGui.Cubix.UI.Settings.language.Languages.ButtonClone.languagebutton.UITextSizeConstraint \\ --
UI["102"] = Instance.new("UITextSizeConstraint", UI["ff"])
UI["102"]["MaxTextSize"] = 25

-- // StarterGui.Cubix.UI.Settings.language.Languages.UIGridLayout \\ --
UI["103"] = Instance.new("UIGridLayout", UI["fd"])
UI["103"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center
UI["103"]["CellSize"] = UDim2.new(0.9, 0, 0.01, 0)
UI["103"]["FillDirectionMaxCells"] = 5
UI["103"]["SortOrder"] = Enum.SortOrder.LayoutOrder

-- // StarterGui.Cubix.UI.Settings.language.Languages.GameTexts \\ --
UI["104"] = Instance.new("TextLabel", UI["fd"])
...
UI["104"]["Size"] = UDim2.new(0, 200, 0, 50)
UI["104"]["Visible"] = false
UI["104"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["104"]["Text"] = [[]]
UI["104"]["Name"] = [[GameTexts]]

-- // StarterGui.Cubix.UI.Settings.language.LocalScript \\ --
UI["105"] = Instance.new("LocalScript", UI["fb"])


-- // StarterGui.Cubix.UI.console \\ --
UI["106"] = Instance.new("Frame", UI["1c"])
UI["106"]["Visible"] = false
UI["106"]["BorderSizePixel"] = 0
UI["106"]["BackgroundColor3"] = Color3.fromRGB(24, 19, 30)
UI["106"]["Size"] = UDim2.new(0.87247, 0, 0.87995, 0)
UI["106"]["Position"] = UDim2.new(0.05322, 0, 0.01754, 0)
...
UI["108"]["Size"] = UDim2.new(0.99992, 0, 0.99688, 0)
UI["108"]["Position"] = UDim2.new(0, 0, 0, 0)
UI["108"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["108"]["Name"] = [[Console]]
UI["108"]["BackgroundTransparency"] = 1

-- // StarterGui.Cubix.UI.console.Console.Name \\ --
UI["109"] = Instance.new("TextLabel", UI["108"])
UI["109"]["TextWrapped"] = true
UI["109"]["BorderSizePixel"] = 0
UI["109"]["TextScaled"] = true
UI["109"]["BackgroundColor3"] = Color3.fromRGB(51, 51, 51)
UI["109"]["TextSize"] = 15
UI["109"]["FontFace"] = Font.new([[rbxasset://fonts/families/JosefinSans.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal)
UI["109"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["109"]["BackgroundTransparency"] = 1
UI["109"]["Size"] = UDim2.new(1, 0, 0.07101, 0)
UI["109"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["109"]["Text"] = [[Console Logs]]
UI["109"]["Name"] = [[Name]]
UI["109"]["Position"] = UDim2.new(0, 0, 0, 0)
...
UI["10b"] = Instance.new("ScrollingFrame", UI["108"])
UI["10b"]["Active"] = true
UI["10b"]["BorderSizePixel"] = 0
UI["10b"]["CanvasSize"] = UDim2.new(0, 0, 0, 0)
UI["10b"]["BackgroundColor3"] = Color3.fromRGB(57, 57, 57)
UI["10b"]["Name"] = [[Scroller]]
UI["10b"]["ScrollBarImageTransparency"] = 1
UI["10b"]["AutomaticCanvasSize"] = Enum.AutomaticSize.XY
UI["10b"]["Size"] = UDim2.new(0.9629, 0, 0.85356, 0)
UI["10b"]["Position"] = UDim2.new(0.02087, 0, 0.04958, 0)
UI["10b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["10b"]["ScrollBarThickness"] = 10
...
UI["10d"] = Instance.new("TextLabel", UI["10b"])
...
UI["10d"]["TextSize"] = 15
UI["10d"]["FontFace"] = Font.new([[rbxasset://fonts/families/Inconsolata.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal)
UI["10d"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["10d"]["BackgroundTransparency"] = 1
UI["10d"]["Size"] = UDim2.new(1, 0, 0.125, 0)
UI["10d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["10d"]["Text"] = [[-- All Consoles errors logs here]]
UI["10d"]["Name"] = [[_Line_]]
UI["10d"]["Position"] = UDim2.new(-0.02248, 0, -0.03023, 0)
...
UI["10f"] = Instance.new("Frame", UI["108"])
UI["10f"]["ZIndex"] = 9
UI["10f"]["BorderSizePixel"] = 0
UI["10f"]["BackgroundColor3"] = Color3.fromRGB(17, 11, 23)
UI["10f"]["Size"] = UDim2.new(0.12907, 0, 0.17868, 0)
UI["10f"]["Position"] = UDim2.new(0.9358, 0, 0.81713, 0)
UI["10f"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["10f"]["Name"] = [[Buttons]]

-- // StarterGui.Cubix.UI.console.Console.Buttons.UICorner \\ --
UI["110"] = Instance.new("UICorner", UI["10f"])
UI["110"]["CornerRadius"] = UDim.new(0.15, 0)

-- // StarterGui.Cubix.UI.console.Console.Buttons.UIStroke \\ --
UI["111"] = Instance.new("UIStroke", UI["10f"])
UI["111"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border
UI["111"]["Thickness"] = 4
UI["111"]["Color"] = Color3.fromRGB(26, 16, 35)

-- // StarterGui.Cubix.UI.console.Console.Buttons.BottomConsole \\ --
UI["112"] = Instance.new("Folder", UI["10f"])
UI["112"]["Name"] = [[BottomConsole]]
...
UI["113"]["Size"] = UDim2.new(0.08116, 0, 0.084, 0)
UI["113"]["BackgroundTransparency"] = 1
UI["113"]["Name"] = [[Save]]
UI["113"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["113"]["Text"] = [[save]]
UI["113"]["Visible"] = false
UI["113"]["Position"] = UDim2.new(0.98386, 0, 0.90314, 0)
...
UI["115"] = Instance.new("Frame", UI["112"])
UI["115"]["ZIndex"] = 9
UI["115"]["BorderSizePixel"] = 0
UI["115"]["BackgroundColor3"] = Color3.fromRGB(24, 14, 37)
UI["115"]["Size"] = UDim2.new(0.31933, 0, 0.38782, 0)
UI["115"]["Position"] = UDim2.new(0.05099, 0, 0.05962, 0)
UI["115"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["115"]["Name"] = [[Clear]]

-- // StarterGui.Cubix.UI.console.Console.Buttons.BottomConsole.Clear.UICorner \\ --
UI["116"] = Instance.new("UICorner", UI["115"])
UI["116"]["CornerRadius"] = UDim.new(0.34, 0)

-- // StarterGui.Cubix.UI.console.Console.Buttons.BottomConsole.Clear.TextLabel \\ --
UI["117"] = Instance.new("TextLabel", UI["115"])
UI["117"]["TextWrapped"] = true
UI["117"]["BorderSizePixel"] = 0
UI["117"]["TextScaled"] = true
UI["117"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["117"]["TextSize"] = 13
UI["117"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["117"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["117"]["BackgroundTransparency"] = 1
UI["117"]["Size"] = UDim2.new(1.55263, 0, 0.52632, 0)
UI["117"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["117"]["Text"] = [[Clear]]
UI["117"]["Position"] = UDim2.new(1.09464, 0, 0.23684, 0)
...
UI["11a"]["TextSize"] = 14
UI["11a"]["TextColor3"] = Color3.fromRGB(0, 0, 0)
UI["11a"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["11a"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal)
UI["11a"]["Size"] = UDim2.new(0, 126, 0, 43)
UI["11a"]["BackgroundTransparency"] = 1
UI["11a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["11a"]["Text"] = [[]]
UI["11a"]["Position"] = UDim2.new(-0.01198, 0, 0, 0)

-- // StarterGui.Cubix.UI.console.Console.Buttons.BottomConsole.Copy \\ --
UI["11b"] = Instance.new("Frame", UI["112"])
UI["11b"]["BorderSizePixel"] = 0
UI["11b"]["BackgroundColor3"] = Color3.fromRGB(24, 14, 37)
UI["11b"]["Size"] = UDim2.new(0.31933, 0, 0.38782, 0)
UI["11b"]["Position"] = UDim2.new(0.05099, 0, 0.55175, 0)
...
UI["124"]["BackgroundColor3"] = Color3.fromRGB(66, 66, 66)
UI["124"]["Size"] = UDim2.new(0.06876, 0, 0.10762, 0)
UI["124"]["BackgroundTransparency"] = 1
UI["124"]["Name"] = [[Print]]
UI["124"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["124"]["Text"] = [[print: on]]
UI["124"]["Visible"] = false
UI["124"]["Position"] = UDim2.new(0.96567, 0, 0.44167, 0)

-- // StarterGui.Cubix.UI.console.Console.Buttons.Modes.Print.UITextSizeConstraint \\ --
UI["125"] = Instance.new("UITextSizeConstraint", UI["124"])
UI["125"]["MaxTextSize"] = 15
...
UI["126"]["TextSize"] = 15
UI["126"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["126"]["TextScaled"] = true
UI["126"]["BackgroundColor3"] = Color3.fromRGB(66, 66, 66)
UI["126"]["Size"] = UDim2.new(0.06876, 0, 0.10762, 0)
UI["126"]["BackgroundTransparency"] = 1
UI["126"]["Name"] = [[Error]]
UI["126"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["126"]["Text"] = [[error: on]]
UI["126"]["Visible"] = false
UI["126"]["Position"] = UDim2.new(0.96567, 0, 0.65724, 0)

-- // StarterGui.Cubix.UI.console.Console.Buttons.Modes.Error.UITextSizeConstraint \\ --
UI["127"] = Instance.new("UITextSizeConstraint", UI["126"])
UI["127"]["MaxTextSize"] = 15

-- // StarterGui.Cubix.UI.console.Console.Buttons.Modes.Info \\ --
UI["128"] = Instance.new("TextButton", UI["121"])
UI["128"]["TextWrapped"] = true
UI["128"]["BorderSizePixel"] = 0
UI["128"]["TextSize"] = 15
UI["128"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["128"]["TextScaled"] = true
UI["128"]["BackgroundColor3"] = Color3.fromRGB(66, 66, 66)
UI["128"]["Size"] = UDim2.new(0.06876, 0, 0.10762, 0)
UI["128"]["BackgroundTransparency"] = 1
UI["128"]["Name"] = [[Info]]
UI["128"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["128"]["Text"] = [[info: on]]
UI["128"]["Visible"] = false
UI["128"]["Position"] = UDim2.new(0.96567, 0, 0.33388, 0)
...
UI["129"]["MaxTextSize"] = 15

-- // StarterGui.Cubix.UI.console.LocalScript \\ --
UI["12a"] = Instance.new("LocalScript", UI["106"])


-- // StarterGui.Cubix.ImageLabel \\ --
UI["12b"] = Instance.new("ImageLabel", UI["1"])
UI["12b"]["BorderSizePixel"] = 0
UI["12b"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["12b"]["ImageTransparency"] = 1
UI["12b"]["Image"] = [[rbxassetid://17360996086]]
UI["12b"]["Size"] = UDim2.new(1, 0, 1, 0)
UI["12b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["12b"]["BackgroundTransparency"] = 1

-- // StarterGui.Cubix.CubiXIntro \\ --
UI["12c"] = Instance.new("ScreenGui", UI["1"])
UI["12c"]["IgnoreGuiInset"] = true
UI["12c"]["Enabled"] = false
UI["12c"]["ScreenInsets"] = Enum.ScreenInsets.DeviceSafeInsets
UI["12c"]["Name"] = [[CubiXIntro]]
UI["12c"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling

-- // StarterGui.Cubix.CubiXIntro.Frame \\ --
UI["12d"] = Instance.new("Frame", UI["12c"])
UI["12d"]["BorderSizePixel"] = 0
UI["12d"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
UI["12d"]["AnchorPoint"] = Vector2.new(0.5, 0.5)
UI["12d"]["Size"] = UDim2.new(2, 0, 2, 0)
UI["12d"]["Position"] = UDim2.new(0.5, 0, 0.5, 0)
UI["12d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)

-- // StarterGui.Cubix.CubiXIntro.Frame.LogoImage \\ --
UI["12e"] = Instance.new("ImageLabel", UI["12d"])
UI["12e"]["BorderSizePixel"] = 0
UI["12e"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["12e"]["AnchorPoint"] = Vector2.new(0.5, 0.5)
UI["12e"]["Image"] = [[rbxassetid://16646719798]]
UI["12e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["12e"]["BackgroundTransparency"] = 1
UI["12e"]["Rotation"] = 360
UI["12e"]["Name"] = [[LogoImage]]
UI["12e"]["Position"] = UDim2.new(0.49996, 0, 0.49957, 0)

-- // StarterGui.Cubix.CubiXIntro.Frame.LogoImage.UIAspectRatioConstraint \\ --
UI["12f"] = Instance.new("UIAspectRatioConstraint", UI["12e"])


-- // StarterGui.Cubix.CubiXIntro.Frame.ImageLabel \\ --
UI["130"] = Instance.new("ImageLabel", UI["12d"])
UI["130"]["BorderSizePixel"] = 0
UI["130"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["130"]["AnchorPoint"] = Vector2.new(0.5, 0.5)
UI["130"]["Image"] = [[rbxassetid://16646719798]]
UI["130"]["Size"] = UDim2.new(0.06562, 0, 0.12223, 0)
UI["130"]["Visible"] = false
UI["130"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["130"]["BackgroundTransparency"] = 1
UI["130"]["Position"] = UDim2.new(0.45622, 0, 0.49957, 0)

-- // StarterGui.Cubix.CubiXIntro.Frame.ImageLabel.UIAspectRatioConstraint \\ --
UI["131"] = Instance.new("UIAspectRatioConstraint", UI["130"])


-- // StarterGui.Cubix.CubiXIntro.Frame.TextButton \\ --
UI["132"] = Instance.new("TextLabel", UI["12d"])
UI["132"]["TextWrapped"] = true
UI["132"]["Active"] = true
UI["132"]["BorderSizePixel"] = 0
UI["132"]["TextXAlignment"] = Enum.TextXAlignment.Left
UI["132"]["TextScaled"] = true
UI["132"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["132"]["TextSize"] = 46
UI["132"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["132"]["TextColor3"] = Color3.fromRGB(246, 246, 246)
UI["132"]["BackgroundTransparency"] = 1
UI["132"]["AnchorPoint"] = Vector2.new(0.5, 0.5)
UI["132"]["Size"] = UDim2.new(0.11588, 0, 0.06068, 0)
UI["132"]["Visible"] = false
UI["132"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["132"]["Text"] = [[CubiX]]
UI["132"]["Selectable"] = true
UI["132"]["Name"] = [[TextButton]]
UI["132"]["Position"] = UDim2.new(0.54987, 0, 0.49957, 0)

-- // StarterGui.Cubix.CubiXIntro.Frame.TextButton.UIGradient \\ --
UI["133"] = Instance.new("UIGradient", UI["132"])
UI["133"]["Rotation"] = 51
UI["133"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(255, 255, 255)),ColorSequenceKeypoint.new(0.150, Color3.fromRGB(255, 255, 255)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(137, 137, 137))}

-- // StarterGui.Cubix.CubiXIntro.Frame.LogoText \\ --
UI["134"] = Instance.new("TextLabel", UI["12d"])
UI["134"]["TextWrapped"] = true
UI["134"]["Active"] = true
UI["134"]["BorderSizePixel"] = 0
UI["134"]["TextXAlignment"] = Enum.TextXAlignment.Left
UI["134"]["TextTransparency"] = 1
UI["134"]["TextScaled"] = true
UI["134"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["134"]["TextSize"] = 46
UI["134"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["134"]["TextColor3"] = Color3.fromRGB(246, 246, 246)
UI["134"]["BackgroundTransparency"] = 1
UI["134"]["AnchorPoint"] = Vector2.new(0.5, 0.5)
UI["134"]["Size"] = UDim2.new(0.11588, 0, 0.06068, 0)
UI["134"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["134"]["Text"] = [[]]
UI["134"]["Selectable"] = true
UI["134"]["Name"] = [[LogoText]]
UI["134"]["Position"] = UDim2.new(0.54708, 0, 0.49957, 0)

-- // StarterGui.Cubix.CubiXIntro.Frame.LogoText.UIGradient \\ --
UI["135"] = Instance.new("UIGradient", UI["134"])
UI["135"]["Rotation"] = 51
UI["135"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(255, 255, 255)),ColorSequenceKeypoint.new(0.150, Color3.fromRGB(255, 255, 255)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(137, 137, 137))}

-- // StarterGui.Cubix.CubiXIntro.LocalScript \\ --
UI["136"] = Instance.new("LocalScript", UI["12c"])


-- // StarterGui.Cubix.NFMessage \\ --
UI["137"] = Instance.new("Folder", UI["1"])
UI["137"]["Name"] = [[NFMessage]]

-- // StarterGui.Cubix.NFMessage.LocalScript \\ --
UI["138"] = Instance.new("LocalScript", UI["137"])


-- // StarterGui.Cubix.NFMessage.Cln \\ --
UI["139"] = Instance.new("Folder", UI["137"])
UI["139"]["Name"] = [[Cln]]

-- // StarterGui.Cubix.NFMessage.Cln.Nifocation \\ --
UI["13a"] = Instance.new("Frame", UI["139"])
UI["13a"]["BorderSizePixel"] = 0
UI["13a"]["BackgroundColor3"] = Color3.fromRGB(30, 19, 41)
UI["13a"]["Size"] = UDim2.new(0.42669, 0, 0.1331, 0)
UI["13a"]["Position"] = UDim2.new(0.314, 0, -1, 0)
UI["13a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["13a"]["Name"] = [[Nifocation]]

-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Frame \\ --
UI["13b"] = Instance.new("Frame", UI["13a"])
UI["13b"]["BorderSizePixel"] = 0
UI["13b"]["BackgroundColor3"] = Color3.fromRGB(17, 11, 23)
UI["13b"]["Size"] = UDim2.new(1, 0, 0.06024, 0)
UI["13b"]["Position"] = UDim2.new(0, 0, 0.97925, 0)
UI["13b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)

-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Message \\ --
UI["13c"] = Instance.new("TextLabel", UI["13a"])
UI["13c"]["TextWrapped"] = true
UI["13c"]["BorderSizePixel"] = 0
UI["13c"]["TextXAlignment"] = Enum.TextXAlignment.Left
UI["13c"]["TextYAlignment"] = Enum.TextYAlignment.Top
UI["13c"]["TextScaled"] = true
UI["13c"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["13c"]["TextSize"] = 35
UI["13c"]["FontFace"] = Font.new([[rbxassetid://12187377099]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["13c"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["13c"]["BackgroundTransparency"] = 1
UI["13c"]["RichText"] = true
UI["13c"]["Size"] = UDim2.new(0.72305, 0, 0.80161, 0)
UI["13c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["13c"]["Text"] = [[Youtube Channel I Click here to Copy the link]]
UI["13c"]["Name"] = [[Message]]
UI["13c"]["Position"] = UDim2.new(0.26016, 0, 0.0755, 0)

-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Message.UITextSizeConstraint \\ --
UI["13d"] = Instance.new("UITextSizeConstraint", UI["13c"])
UI["13d"]["MaxTextSize"] = 35

-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Image \\ --
UI["13e"] = Instance.new("ImageLabel", UI["13a"])
UI["13e"]["BorderSizePixel"] = 0
UI["13e"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["13e"]["Image"] = [[rbxassetid://17363232722]]
UI["13e"]["Size"] = UDim2.new(0.31448, 0, 1.06031, 0)
UI["13e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["13e"]["BackgroundTransparency"] = 1
UI["13e"]["Name"] = [[Image]]
UI["13e"]["Position"] = UDim2.new(-0.08286, 0, -0.00191, 0)
...
UI["140"] = Instance.new("Frame", UI["13a"])
UI["140"]["BorderSizePixel"] = 0
UI["140"]["BackgroundColor3"] = Color3.fromRGB(18, 11, 28)
UI["140"]["Size"] = UDim2.new(0.0833, 0, 0.47332, 0)
UI["140"]["Position"] = UDim2.new(0.89844, 0, 0.39516, 0)
UI["140"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["140"]["Name"] = [[Button]]

-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Button.UICorner \\ --
UI["141"] = Instance.new("UICorner", UI["140"])
UI["141"]["CornerRadius"] = UDim.new(0.34, 0)

-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Button.Copy \\ --
UI["142"] = Instance.new("ImageButton", UI["140"])
UI["142"]["BorderSizePixel"] = 0
UI["142"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["142"]["Image"] = [[rbxassetid://17371144983]]
UI["142"]["Size"] = UDim2.new(0.841, 0, 0.737, 0)
UI["142"]["BackgroundTransparency"] = 1
UI["142"]["Name"] = [[Copy]]
UI["142"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["142"]["Position"] = UDim2.new(0.079, 0, 0.132, 0)
...
local function SCRIPT_c8()
	...
	local close = down.Folder.Frame.ImageButton
	local b5 = down.Console.ImageButton
	...
	-- Define custom tween information for buttons
	...
	-- Define custom transparency values for elements inside frames
	...
	local buttons = {b1, b2, b3, b4, b5} 
	local frames = {f1, f2, f3, f4, f5} 

	local function createTween(element, transparency, tweenInfo)
		return TweenService:Create(element, tweenInfo, {BackgroundTransparency = transparency})
	end

	local function handleButtonClick(clickedButton, clickedFrame)
		-- Show the clicked frame
		clickedFrame.Visible = true

		-- Enable animation for the clicked button
		createTween(clickedButton.Parent, 0, buttonTweenInfo):Play()

		-- Apply custom tweens to elements inside frames
		for frame, transparency in pairs(elementTransparency) do
			if frame == clickedFrame then
				for _, element in ipairs(frame:GetChildren()) do
					if element:IsA("GuiObject") then
						createTween(element, transparency, buttonTweenInfo):Play()
					end
				end
			else
				-- Hide other frames
				...
				-- Reset transparency for elements inside other frames
				for _, element in ipairs(frame:GetChildren()) do
					if element:IsA("GuiObject") then
						createTween(element, 1, buttonTweenInfo):Play()
					end
				end
			end
		end

		-- Disable animations for all other buttons
		for _, button in ipairs(buttons) do
			if button ~= clickedButton then
				createTween(button.Parent, 1, buttonTweenInfo):Play()
			end
		end
	end
	...
	for i, button in ipairs(buttons) do
		button.MouseButton1Click:Connect(function()
			handleButtonClick(button, frames[i])
		end)
	end
...
local function SCRIPT_d8()
	...
	local function makeCX(params)
		...
		hitbox.Size = UDim2.new(0, 80, 0, 80)  
...
-- // StarterGui.Cubix.UI.Settings.language.LocalScript \\ --
local function SCRIPT_105()
	local script = UI["105"]
	local scrolling = script.Parent.Languages
	local bt = scrolling.ButtonClone.languagebutton
	local gametexts = scrolling.GameTexts
	...
	local function find(Lang)
		...
		for Ind, Val in pairs(Languages) do
			if Ind == Lang or Val:lower() == Lang then
				return Ind
			end
		end
	end
	...
	local function getAllTexts(parent)
		local texts = {}
	...
	local function CreateLanguageButton(langCode, langName)
		local button = bt:Clone()
		button.Name = langCode
		button.Text = langName
		button.Parent = scrolling
		button.Visible = true

		button.MouseButton1Click:Connect(function()
			local allTexts = getAllTexts(game)
			for _, textElement in ipairs(allTexts) do
				textElement.Text = TranslateTo(textElement.Text, langCode)
			end
		end)
	end

	for langCode, langName in pairs(Languages) do
		CreateLanguageButton(langCode, langName)
	end

	local allTexts = getAllTexts(game)
	local allTextInfo = {}
	for _, textElement in ipairs(allTexts) do
		table.insert(allTextInfo, ("%s.%s.%s"):format(textElement.Parent.Name, textElement.Name, textElement.Text))
	end
	gametexts.Text = table.concat(allTextInfo, ", ")
