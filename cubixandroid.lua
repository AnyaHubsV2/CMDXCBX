function LoadUI()
	...
	UI["12c"] = Instance.new("Folder", UI["1"])
	UI["12c"]["Name"] = [[NFMessage]]

	-- // StarterGui.Cubix.NFMessage.LocalScript \\ --
	UI["12d"] = Instance.new("LocalScript", UI["12c"])


	-- // StarterGui.Cubix.NFMessage.Cln \\ --
	UI["12e"] = Instance.new("Folder", UI["12c"])
	UI["12e"]["Name"] = [[Cln]]

	-- // StarterGui.Cubix.NFMessage.Cln.Nifocation \\ --
	UI["12f"] = Instance.new("Frame", UI["12e"])
	UI["12f"]["BorderSizePixel"] = 0
	UI["12f"]["BackgroundColor3"] = Color3.fromRGB(30, 19, 41)
	UI["12f"]["Size"] = UDim2.new(0.42669, 0, 0.1331, 0)
	UI["12f"]["Position"] = UDim2.new(0.314, 0, -1, 0)
	UI["12f"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
	UI["12f"]["Name"] = [[Nifocation]]

	-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Frame \\ --
	UI["130"] = Instance.new("Frame", UI["12f"])
	UI["130"]["BorderSizePixel"] = 0
	UI["130"]["BackgroundColor3"] = Color3.fromRGB(17, 11, 23)
	UI["130"]["Size"] = UDim2.new(1, 0, 0.06024, 0)
	UI["130"]["Position"] = UDim2.new(0, 0, 0.97925, 0)
	UI["130"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)

	-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Message \\ --
	UI["131"] = Instance.new("TextLabel", UI["12f"])
	UI["131"]["TextWrapped"] = true
	UI["131"]["BorderSizePixel"] = 0
	UI["131"]["TextXAlignment"] = Enum.TextXAlignment.Left
	UI["131"]["TextYAlignment"] = Enum.TextYAlignment.Top
	UI["131"]["TextScaled"] = true
	UI["131"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
	UI["131"]["TextSize"] = 35
	UI["131"]["FontFace"] = Font.new([[rbxassetid://12187377099]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
	UI["131"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
	UI["131"]["BackgroundTransparency"] = 1
	UI["131"]["RichText"] = true
	UI["131"]["Size"] = UDim2.new(0.72305, 0, 0.80161, 0)
	UI["131"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
	UI["131"]["Text"] = [[Youtube Channel I Click here to Copy the link]]
	UI["131"]["Name"] = [[Message]]
	UI["131"]["Position"] = UDim2.new(0.26016, 0, 0.0755, 0)

	-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Message.UITextSizeConstraint \\ --
	UI["132"] = Instance.new("UITextSizeConstraint", UI["131"])
	UI["132"]["MaxTextSize"] = 35

	-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Image \\ --
	UI["133"] = Instance.new("ImageLabel", UI["12f"])
	UI["133"]["BorderSizePixel"] = 0
	UI["133"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
	UI["133"]["Image"] = [[rbxassetid://17363232722]]
	UI["133"]["Size"] = UDim2.new(0.31448, 0, 1.06031, 0)
	UI["133"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
	UI["133"]["BackgroundTransparency"] = 1
	UI["133"]["Name"] = [[Image]]
	UI["133"]["Position"] = UDim2.new(-0.08286, 0, -0.00191, 0)

	-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Image.UICorner \\ --
	UI["134"] = Instance.new("UICorner", UI["133"])


	-- // StarterGui.Cubix.NFMessage.Cln.Nifocation.Button \\ --
	UI["135"] = Instance.new("Frame", UI["12f"])
	UI["135"]["BorderSizePixel"] = 0
	UI["135"]["BackgroundColor3"] = Color3.fromRGB(18, 11, 28)
	UI["135"]["Size"] = UDim2.new(0.0833, 0, 0.47332, 0)
	UI["135"]["Position"] = UDim2.new(0.89844, 0, 0.39516, 0)
	...
	local function SCRIPT_12d()
		...
		local function msg(MSG, CopyMessage, timer)
			local main = script.Parent.Cln.Nifocation:Clone()
			...
			-- Tween to second position after specified time or default to 3 seconds
			wait(timer or 3)
